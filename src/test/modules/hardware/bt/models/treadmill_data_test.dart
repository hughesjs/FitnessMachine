...
void main() {
  group('Status parsing tests', () {
    test("Speed parsing 1kmh", () {
      ...
      var res = TreadmillData.fromBytes(data);
    ...
    test("Time parsing 300s", () {
      var data = [0x84, 0x24, 0x64, 0x00, 0x20, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2c, 0x01, 0x38, 0x00, 0x00];
      var res = TreadmillData.fromBytes(data);
    ...
    test("Long walk parsing:", () {
      var data = [0x84, 0x24, 0x58, 0x02, 0x4e, 0x20, 0x00, 0x11, 0x01, 0xff, 0xff, 0xff, 0x52, 0x17, 0x17, 0x27, 0x00];
      const expected = TreadmillData(speedInKmh: 6.0, distanceInKm: 8.27, indicatedKiloCalories: 273, timeInSeconds: 5970, steps: 10007);

      var res = TreadmillData.fromBytes(data);
      expect(res.speedInKmh, expected.speedInKmh);
      expect(res.distanceInKm, expected.distanceInKm);
      expect(res.indicatedKiloCalories, expected.indicatedKiloCalories);
